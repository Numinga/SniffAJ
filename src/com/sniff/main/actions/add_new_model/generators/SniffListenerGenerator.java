 ...
 */
public class SniffListenerGenerator extends SniffBaseModelGenerator {
    private SniffMethodGenerator mMethod;
    public SniffListenerGenerator(String modelName, String aPackage, SniffMethodGenerator method) {
    ...
    public String generate() {
        return Templates.mListenerBody.replace(SniffModelCreationController.cName, mMethod.getMethodName())
