 ...
 */
public class ResponseParserGenerator extends SniffBaseInitGenerator {

    public ResponseParserGenerator(String projectPath, String aPackage, String modelPath) {
        super(projectPath, aPackage, modelPath);
    }

    @Override
    public String generate() {
        return Templates.sResponseParserBody.replace(SniffInitCreationController.cPackage, mPackage);
    }
}