 ...
 */
public class HandledStringRequestGenerator extends SniffBaseInitGenerator {

    public HandledStringRequestGenerator(String projectPath, String aPackage, String modelPath) {
        super(projectPath, aPackage, modelPath);
    }

    @Override
    public String generate() {
        return Templates.sHandledStringRequestBody.replace(SniffInitCreationController.cPackage, mPackage);
    }
}