 ...
 */
public class ResponseListenerGenerator extends SniffBaseInitGenerator {

    public ResponseListenerGenerator(String projectPath, String aPackage, String modelPath) {
        super(projectPath, aPackage, modelPath);
    }

    @Override
    public String generate() {
        return Templates.sResponseListenerBody.replace(SniffInitCreationController.cPackage, mPackage);
    }
}
