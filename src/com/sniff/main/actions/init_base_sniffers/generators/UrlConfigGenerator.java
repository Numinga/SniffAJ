 ...
 */
public class UrlConfigGenerator extends SniffBaseInitGenerator {

    public UrlConfigGenerator(String projectPath, String aPackage, String modelPath) {
        super(projectPath, aPackage, modelPath);
    }

    @Override
    public String generate() {
        return Templates.sUrlConfigBody.replace(SniffInitCreationController.cPackage, mPackage);
    }
}
