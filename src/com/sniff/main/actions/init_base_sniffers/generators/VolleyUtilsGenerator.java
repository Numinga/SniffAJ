 ...
 */
public class VolleyUtilsGenerator extends SniffBaseInitGenerator {

    public VolleyUtilsGenerator(String projectPath, String aPackage, String modelPath) {
        super(projectPath, aPackage, modelPath);
    }

    @Override
    public String generate() {
        return Templates.sVolleyUtilsBody.replace(SniffInitCreationController.cPackage, mPackage);
    }
}
